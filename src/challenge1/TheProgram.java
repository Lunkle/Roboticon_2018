...
/**
 * Roboticon 2018 Team Name: Lethargic Walnuts
 * Team Members: Donny Ren, Dan Choi, John Tzoganakis, Matthew Zhou
 * Competition Date: March 18-19
 * @author Donny Ren
 */
public class TheProgram {
	...
	// Black - White average Colour Value -- Must remember to change this at tournament
...
//		TheProgram.armMotor.rotateTo(0);
	...
	private static void startLineFollowingThreads() {
		...
		// Start arm motor
		ArmCatch armCatchThread = new ArmCatch();
		armCatchThread.start();
